...
- Compatibility (Folder)
  - 0.#.#
    - 0.#.# EXE
    - display.txt (You need to type in what you want this EXE to display as in the launcher via this file.)
- Compatibility (Folder)
  - 0.#.#
    - 0.#.# EXE
    - display.txt (You need to type in what you want this EXE to display as in the launcher via this file.)

Or, you can add the version inside the launcher by uploading the EXE into the right drop-in box.
...
## Folder Set-Up Examples
<img width="717" height="223" alt="Screenshot 2026-08-22 125445" src="https://github.com/user-attachments/assets/ba1c2acf-99bd-4a33-8c8d-03c1bf0be242" />

### Root Folder [The .ico file isn't necessary] ^^^
